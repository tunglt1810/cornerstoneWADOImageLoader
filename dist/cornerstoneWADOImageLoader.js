...
function metaDataProvider(type, imageId) {
  ...
  if (type === 'overlayPlaneModule') {
    ...
    for (var overlayGroup = 0x00; overlayGroup <= 0x1E; overlayGroup += 0x02) {
      ...
      var data = Object(_getValue_js__WEBPACK_IMPORTED_MODULE_2__["default"])(metaData["".concat(groupStr, "3000")]);
      ...
      for (var i = 0; i < data.length; i++) {
        for (var k = 0; k < 8; k++) {
          var byte_as_int = metaData.Value[data.dataOffset + i];
          pixelData[i * 8 + k] = byte_as_int >> k & 1; // eslint-disable-line no-bitwise
        }
      }

      overlays.push({
        rows: Object(_getNumberValue_js__WEBPACK_IMPORTED_MODULE_3__["default"])(metaData["".concat(groupStr, "0010")]),
        columns: Object(_getNumberValue_js__WEBPACK_IMPORTED_MODULE_3__["default"])(metaData["".concat(groupStr, "0011")]),
        type: Object(_getValue_js__WEBPACK_IMPORTED_MODULE_2__["default"])(metaData["".concat(groupStr, "0040")]),
        x: Object(_getNumberValue_js__WEBPACK_IMPORTED_MODULE_3__["default"])(metaData["".concat(groupStr, "0050")], 1) - 1,
        y: Object(_getNumberValue_js__WEBPACK_IMPORTED_MODULE_3__["default"])(metaData["".concat(groupStr, "0050")], 0) - 1,
        pixelData: pixelData,
        description: Object(_getValue_js__WEBPACK_IMPORTED_MODULE_2__["default"])(metaData["".concat(groupStr, "0022")]),
        label: Object(_getValue_js__WEBPACK_IMPORTED_MODULE_2__["default"])(metaData["".concat(groupStr, "1500")]),
        roiArea: Object(_getValue_js__WEBPACK_IMPORTED_MODULE_2__["default"])(metaData["".concat(groupStr, "1301")]),
        roiMean: Object(_getValue_js__WEBPACK_IMPORTED_MODULE_2__["default"])(metaData["".concat(groupStr, "1302")]),
        roiStandardDeviation: Object(_getValue_js__WEBPACK_IMPORTED_MODULE_2__["default"])(metaData["".concat(groupStr, "1303")])
      });
    }
